  ...
  <SheetPortal>
    ...
    <SheetPrimitive.Content
      ...
      className={cn(
        ...
        side === "bottom" &&
          "inset-x-0 bottom-0 border-t data-[state=closed]:slide-out-to-bottom data-[state=open]:slide-in-from-bottom rounded-t-lg max-h-[85vh] overflow-y-auto p-4 sm:p-6",
        side === "left" &&
          "inset-y-0 left-0 h-full w-11/12 sm:w-3/4 border-r data-[state=closed]:slide-out-to-left data-[state=open]:slide-in-from-left sm:max-w-sm p-4 sm:p-6 overflow-y-auto",
        side === "right" &&
          "inset-y-0 right-0 h-full w-11/12 sm:w-3/4 border-l data-[state=closed]:slide-out-to-right data-[state=open]:slide-in-from-right sm:max-w-sm p-4 sm:p-6 overflow-y-auto",
        className
      )}
      {...props}
    >
