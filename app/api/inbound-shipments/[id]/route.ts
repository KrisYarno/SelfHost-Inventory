 ...
 */
async function lockLine(tx: Prisma.TransactionClient, itemId: number): Promise<void> {
  await tx.stagingItem.updateMany({
    where: { id: itemId, status: StagingItemStatus.RECEIVED },
